    ...
    fields: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            value: "tray",
            label: t("settings.fields.app_close_action.optTray"),
          },
          {
            value: "quit",
            label: t("settings.fields.app_close_action.optQuit"),
          },
        ],
      },
      {
    ...
    fields: [
      {
        ...
        label: t("settings.fields.download_concurrency.label"),
        type: "number",
        min: 1,
        max: 64,
        hint: t("settings.fields.download_concurrency.hint", {
          cores: cpuCores,
          suggested: suggestedConcurrency,
        }),
      },
      {
        key: "download.timeout_secs",
        label: t("settings.fields.download_timeout_secs.label"),
        type: "number",
        min: 5,
        max: 120,
        hint: t("settings.fields.download_timeout_secs.hint"),
      },
      {
        key: "download.max_retries",
        label: t("settings.fields.download_max_retries.label"),
        type: "number",
        min: 0,
        max: 10,
        hint: t("settings.fields.download_max_retries.hint"),
      },
      {
        key: "download.retry_delay_ms",
        label: t("settings.fields.download_retry_delay_ms.label"),
        type: "number",
        min: 100,
        max: 10000,
        hint: t("settings.fields.download_retry_delay_ms.hint"),
      },
      {
        key: "download.delay_min_ms",
        label: t("settings.fields.download_delay_min_ms.label"),
        type: "number",
        min: 0,
        max: 5000,
        hint: t("settings.fields.download_delay_min_ms.hint"),
      },
      {
        key: "download.delay_max_ms",
        label: t("settings.fields.download_delay_max_ms.label"),
        type: "number",
        min: 0,
        max: 5000,
        hint: t("settings.fields.download_delay_max_ms.hint"),
      },
      {
        key: "tasks.max_concurrent",
        label: t("settings.fields.tasks_max_concurrent.label"),
        type: "number",
        min: 0,
        max: 20,
        hint: t("settings.fields.tasks_max_concurrent.hint"),
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        label: t("settings.fields.server_default_port.label"),
        type: "number",
        min: 1024,
        max: 65535,
    ...
    fields: [
      {
        ...
        label: t("settings.fields.network_proxy_enabled.label"),
        type: "toggle",
        hint: t("settings.fields.network_proxy_enabled.hint"),
      },
      {
        key: "network.proxy_url",
        label: t("settings.fields.network_proxy_url.label"),
        type: "text",
        hint: t("settings.fields.network_proxy_url.hint"),
        placeholder: t("settings.fields.network_proxy_url.placeholder"),
      },
    ],
  },
]);
...
<template>
  <div class="flex flex-col h-full">
    ...
    <div class="flex-1 overflow-y-auto relative">
      <div
        class="flex flex-col gap-4 w-full max-w-2xl mx-auto px-6 py-5 text-sm pb-20"
      >
        <!-- 错误提示 -->
        <div
          v-if="errorMsg"
