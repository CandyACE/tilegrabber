export default {
  ...
  settings: {
    ...
    remote: {
      ...
      serverStoppedHint: 'Other clients cannot connect until the remote server is started',
  ...
  remote: {
    ...
    server: {
      ...
      firewallHint: 'Make sure your firewall allows inbound TCP connections on port {port}',
      ...
      noClients: 'No clients connected',
      switchHint: 'Switching to client mode will automatically stop the remote service',
    },
    switchDialog: {
      title: 'Switch Mode',
      bodyToClient: 'Switching to client mode will immediately stop the remote server and disconnect all connected clients. You will need to re-enable it manually if you switch back.',
      bodyToServer: 'Switching to server mode will disconnect from the current remote server.',
