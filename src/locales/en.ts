export default {
  ...
  taskDetail: {
    ...
    incremental: {
      ...
      extend: "Extend Task",
      import: "Borrow Tiles",
      refreshTitle: "Refresh stale tiles",
      refreshDesc:
        "Mark tiles downloaded earlier than the TTL as pending and resume downloading immediately.",
      ttlLabel: "TTL",
      days: "days",
      refreshConfirm: "Start refresh",
      refreshedHint: "Reset {count} stale tiles and resumed downloading.",
      extendTitle: "Extend task coverage",
      extendDesc:
        "Extend the task's bounding box or zoom range (enlarge only). New tiles are added to the download queue.",
      west: "West",
      east: "East",
      south: "South",
      north: "North",
      minZoom: "Min zoom",
      maxZoom: "Max zoom",
      extendConfirm: "Save & extend",
      extendedHint: "Added {added} new tiles. Total tiles is now {total}.",
      importTitle: "Import tiles from another task",
      importDesc:
        "Copy already-downloaded tiles from a task with the same source (URL / format / CRS) to skip network downloads.",
      importNoneFound: "No compatible source task found.",
